package com.example.productly.util
...
import com.example.productly.AppConstants
import com.example.productly.R
import com.example.productly.Timer
import com.example.productly.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object {
        ...
        private const val CHANNEL_NAME_TIMER = "Productly Timer"
        ...
        fun showTimerExpired(context: Context){
            ...
            val contentIntent = nBuilder.setContentTitle("Timer done!")
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long){
            ...
            val nBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            val contentIntent = nBuilder.setContentTitle("Timer currently running...")
        ...
        fun showTimerPaused(context: Context){
            ...
            val nBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            val contentIntent = nBuilder.setContentTitle("Timer is paused!")
