package com.example.productly.fragments
...
import com.example.productly.fragments.list.ListFragmentDirections
    ...
    companion object{
        ...
        fun  parsePriorityColor (cardView : CardView, priority: Priority){
           when(priority){
               ...
               Priority.MEDIUM -> { cardView.setCardBackgroundColor(cardView.context.getColor(R.color.colorPrimary)) }
